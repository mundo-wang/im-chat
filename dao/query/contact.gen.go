...
func newContact(db *gorm.DB, opts ...gen.DOOption) contact {
	...
	_contact.OwnerID = field.NewInt32(tableName, "owner_id")
	_contact.TargetID = field.NewInt32(tableName, "target_id")
	_contact.Type = field.NewInt32(tableName, "type")
	_contact.Description = field.NewString(tableName, "description")
