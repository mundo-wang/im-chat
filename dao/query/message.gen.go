...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.Description = field.NewString(tableName, "description")
	_message.Amount = field.NewInt32(tableName, "amount")
